...
tag_to_readable_name = {
	...
	"wbcreateclaim-create": _("new claims"),
	"wbsetclaim-update": _("changes claims"),
	"wbsetclaim-create": _("new claims"),
	...
	"wbcreate-new": _("new properties"),
	"wbeditentity-create": _("new properties"),
	"wbeditentity-override": _("clears properties"),
